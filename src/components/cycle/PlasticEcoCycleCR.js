...
// import path1 from "../../assets/path/path_cr_cycle1.svg";
// import path2 from "../../assets/path/path_cr_cycle2.svg";
// import path3 from "../../assets/path/path_cr_cycle3.svg";
// import path4 from "../../assets/path/path_cr_cycle4.svg";
// import path5 from "../../assets/path/path_cr_cycle5.svg";
...
const PlasticEcoCycleMR = ({ isStop }) => {
  ...
  const renderParticle = () => {
    ...
    for (let i = 0; i < cyclePathData2.length; i++) {
      ...
      let duration = d3.select(`.path_cr_${i}`).node().getTotalLength() * 10;
